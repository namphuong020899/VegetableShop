        ...
        <div class="container">
            ...
            <div class="row justify-content-end">
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    <form action="{{ route('add_coupon.store') }}" class="info addcoupon" method="post">
                        <div class="cart-total mb-3">
                            <h3>Coupon Code</h3>
                            <div id="error_sample"></div>
                            <p>Enter your coupon code if you have one</p>
                            <div class="form-group">
                                <label for="">Coupon code</label>
                                <input type="text" id="coupon_code" name="coupon_code" class="form-control text-left px-3" placeholder="">
                            </div>
                        </div>
                        <p><input type="submit" class="btn btn-primary py-3 px-4 submit_coupon" value="Apply Coupon"></p>
                    </form>
                </div>
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    {{--  <div class="cart-total mb-3">
                ...
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    ...
                    @if (Auth::check())
                        @if ($countcart > 0)
                        <p><a href="{{ route('cart.create') }}" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
                        @else
