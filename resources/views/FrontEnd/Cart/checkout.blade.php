                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="address" name="address" required rows="5" placeholder="House number and street name"></textarea>
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="note" name="note" rows="5" placeholder="Enter Note"></textarea>
                                </div>
                            </div>
                            <div class="w-100"></div>
                        </div>
                    ...
                    <div class="row mt-5 pt-3">
                        ...
                        <div class="col-md-12">
                            <div class="cart-detail p-3 p-md-4">
                                ...
                                <p><a href="#" style="border-radius: 0px;line-height: 0.8;" class="btn btn-primary py-3 px-4 submit_a {{ $count > 0 ? '' : 'disabled' }}">Place an order</a></p>
