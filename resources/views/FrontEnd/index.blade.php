            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-12 ftco-animate text-center">
                        ...
                        <p><a href="{{ $slide->slider_url }}" class="btn btn-primary">View Details</a></p>
                    </div>
                    ...
                    <div class="col-md-6 order-md-last align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            ...
                            <div class="text text-center">
                                ...
                                <p><a href="{{ route('all-product.index') }}" class="btn btn-primary">Shop now</a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    <a href="{{ route('detail.show',$our->product_slug) }}" class="img-prod">
                        ...
                        @if ($our->product_price_sale != 0)
                            <span class="status">{{ number_format(100-($our->product_price_sale/$our->product_price)*100) }}%</span>
                        @endif
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="d-flex">
                            <div class="pricing">
                                <p class="price">
                                    @if ($our->product_price_sale != 0)
                                    <span class="mr-2 price-dc">{{ number_format($our->product_price) }} vnđ</span>
                                    <span class="price-sale">{{ number_format($our->product_price_sale) }} vnđ</span>
                                    @else
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
                ...
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                <h3><a href="{{ route('detail.show',$deal_product->product_slug) }}">{{ $deal_product->product_name }}</a></h3>
                <span class="price">{{ number_format($deal_product->product_price) }} <a href="#">now {{ number_format($deal_product->product_price_sale) }} only</a></span>
