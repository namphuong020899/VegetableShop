...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark"
                            ...
                            <form class="app-search position-absolute">
                                <input type="text" class="form-control" id="change_search" placeholder="Search &amp; enter"> <a
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ asset('backend/assets/images/users/1.jpg') }}" alt="user" class="rounded-circle" width="31"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="ti-user m-r-5 m-l-5"></i>
                                    My Profile</a>
                                <a class="dropdown-item" href="{{ route('home.index') }}" target="_blank"><i
                                        class="ti-wallet m-r-5 m-l-5"></i>Home User</a>
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="p-l-30 p-10"><a href="{{ route('profile.index') }}"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('slider.index') }}" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('account.index') }}" aria-expanded="false">
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" id="dataAll">
            <!-- ============================================================== -->
            ...
            <footer class="footer text-center">
                <script>
                    ...
                    class="fas fa-heart text-danger" aria-hidden="true"></i> by <a href="https://sharecode.vn/thanh-vien/nam-nguyen-294780.htm"
    ...
    <style>
        ...
        .parsley-type, .parsley-required, .parsley-equalto, .parsley-pattern{
         color:#ff0000;
        }
